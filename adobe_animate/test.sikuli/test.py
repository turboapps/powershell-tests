...
wait(5)
paste('turbo run animate --using=isolate-edge-wc,creativeclouddesktop --offline --enable=disablefontpreload --name=test' + util.read_extra())
wait(2)
type(Key.ENTER)
...
wait(5)
paste("%USERPROFILE%\\Desktop\\Test.gif")
wait(2)
type(Key.TAB)
wait(3)
type("g")
