...
wait(Pattern("install_complete_1.png").similar(0.75), 240)
...
wait(Pattern("install_complete_2.png").similar(0.90), 240)
click("tab_java.png")
wait("code_java.png")
click(Pattern("run_1.png").targetOffset(-28,0))
...
click(Pattern("solution_c_sharp.png").targetOffset(-20,17))
...
wait(Pattern("install_complete_rust.png").similar(0.90), 240)
click("tab_rust.png")
wait("code_rust.png")
