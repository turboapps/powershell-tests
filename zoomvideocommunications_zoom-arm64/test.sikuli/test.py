# The tests for zoomvideocommunications/zoom, zoomvideocommunications/zoom-x64 and zoomvideocommunications/zoom-arm64 are the same.
...
# Launch the app.
util.launch_shortcut(["Zoom", "Zoom Workplace.lnk"], "Zoom ARM64.lnk")
wait("zoom_window.png")
