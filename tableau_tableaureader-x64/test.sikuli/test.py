...
type(os.path.join(script_path, os.pardir, "resources", "Chapter 1 - First Workbook.twbx") + Key.ENTER)
rightClick(Pattern("keep_only_before.png").targetOffset(-217,-16))
click(Pattern("furniture_context_menu.png").targetOffset(-33,46))
click(Pattern("keep_only_after.png").targetOffset(244,-105))
wait("presentation_bar.png")
type(Key.ESC)
wait(Pattern("keep_only_after.png").targetOffset(244,-105))
type("p", Key.CTRL)
