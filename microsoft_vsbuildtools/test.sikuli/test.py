# This test is a copy of the nodejs/nodejs one: the container front end is
# nodejs, with vsbuildtools layered in to supply the C++ toolchain that
# node-gyp drives. Keep it in step with nodejs_nodejs/test.sikuli/test.py.
