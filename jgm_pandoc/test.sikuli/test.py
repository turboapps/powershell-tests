...
paste('turbo run pandoc --offline --isolate=merge-user' + util.read_extra() + ' -- -s -r html https://pandoc.org/MANUAL.html -o ' + sample_file)
wait(2)
type(Key.ENTER)
...
paste('turbo run pandoc --offline --isolate=merge-user' + util.read_extra() + ' -- -s ' + sample_file + ' -o ' + doc_file)
wait(2)
type(Key.ENTER)
