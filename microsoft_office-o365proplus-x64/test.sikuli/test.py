...
wait(30)
if exists("publisher_choose_theme.png"):
    click(Pattern("publisher_choose_theme_ok.png").targetOffset(48,1))
...
wait(30)
if exists("outlook_theme.png"):
    click("outlook_theme_ok.png")
