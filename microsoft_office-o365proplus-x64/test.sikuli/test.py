...
type("First line")
type(Key.ENTER)
util.paste_text("Second line")
type(Key.ENTER)
util.paste_text("Third line")
type(Key.ENTER)
util.paste_text("Fourth line")
...
util.enter_spreadsheet_column(["1", "2", "=sum(A1, A2)"], "excel_result.png", attempts=3)
...
util.paste_text("subject")
type(Key.TAB)
wait(1)
util.paste_text("content")
