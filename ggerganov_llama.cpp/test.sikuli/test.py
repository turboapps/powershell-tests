...
wait(5)
type('turbo run ggerganov/llama.cpp --using=microsoft/vcredist --offline --name=test -- /C "C:\\llama-avx2\\llama-server.exe" -m C:\\llama-2-7b-chat.Q4_K_M.gguf -n 50 --port 8180 --chat-template llama2')
type(Key.ENTER)
