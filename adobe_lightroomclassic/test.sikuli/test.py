...
wait("tips.png",20)
wait(3)
click(Pattern("tips.png").targetOffset(-43,0))
click("close-tips.png")
wait("lrc-logo.png",30)
if exists(Pattern("not-maximized.png").similar(0.90),10):
    click(Pattern("not-maximized.png").targetOffset(23,0))
...
click(Pattern("close-culling-tips.png").similar(0.90))
wait(5)
