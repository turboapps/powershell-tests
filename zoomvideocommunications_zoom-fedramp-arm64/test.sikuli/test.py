# The tests for zoomvideocommunications/zoom-fedramp-x64 and zoomvideocommunications/zoom-fedramp-arm64 are the same.
...
# Launch the app.
util.launch_shortcut(["Zoom", "Zoom Workplace.lnk"], "Zoom for Government ARM64.lnk")
wait("zoom_window.png")
